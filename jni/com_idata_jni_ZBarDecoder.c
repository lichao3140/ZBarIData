...
#include "com_idata_jni_ZBarDecoder.h"

JNIEXPORT jstring JNICALL Java_com_idata_jni_ZBarDecoder_decodeRaw(
...
JNIEXPORT jstring JNICALL Java_com_idata_jni_ZBarDecoder_decodeCrop(
		JNIEnv *env, jobject obj, jbyteArray img, jint width, jint height,
